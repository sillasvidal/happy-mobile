...
export default function OrphanageDetails() {
  ...
  function handleOpenChatInWhatsapp() {
    Linking.openURL(`https://wa.me/55${orphanage?.whatsapp}?text=Olá!%20Estou%20interessado%20em%20visitar%20o%20orfanato.`);
  }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
       ...
       <RectButton style={styles.contactButton} onPress={handleOpenChatInWhatsapp}>
